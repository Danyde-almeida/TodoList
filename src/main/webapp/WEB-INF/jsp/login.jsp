                      ...
                      />
                            ...
                            <form method="post">
                                <div class="form-outline mb-4">
                                    ...
                                    <input type="email" id="login" value="${login}" name="login"
                                ...
                                <div class="pt-1 mb-4">
                                    <span class="small text-muted" >Pas encore inscrit ? <a class="small text-muted" href="/register">S'inscrire</a> </span>
                                </div>
                        </div>
                    </div>
                </div>
